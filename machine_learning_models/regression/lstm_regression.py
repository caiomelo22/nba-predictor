...
def lstm_regression(season = '2018-2018'):
    ...
    input_shape = (len(X_train), len(dataset.iloc[:, 5:-2].columns)) 
    
    lstm = keras.Sequential()
    lstm.add(keras.layers.LSTM(2, input_shape=input_shape, return_sequences=False))
